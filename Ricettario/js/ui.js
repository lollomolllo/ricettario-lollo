...
const UI = {
    ...
    // Aggiunto il parametro viewMode ('grid' o 'list')
    renderCards: function (ricette, viewMode = 'grid') {
        ...
        ricette.forEach(r => {
            ...
            if (viewMode === 'list') {
                // MODALITÀ ELENCO (Immagine piccola a sinistra, testi a destra)
                html += `
                ...
                // MODALITÀ CARD (Griglia classica)
                // Trasformiamo i tag in "badge" (etichette con bordo e sfondo)
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    <div class="card shadow-sm">
                        <div class="card-header bg-primary text-white">Gestione Categorie</div>
                        <div class="card-body">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card shadow-sm">
                        <div class="card-header bg-success text-white">Gestione Tag</div>
                        <div class="card-body">
                            <div class="input-group mb-3">
    ...
    renderInserimento: function () {
        this.container.innerHTML = `
            <h2 class="mb-4">Nuova Ricetta (Distinta Base)</h2>
            <form id="form-ricetta">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3"><label class="form-label fw-bold">Tags</label><div id="container-tags" class="border rounded p-2 bg-light" style="max-height: 80px; overflow-y: auto;"></div></div>
                ...
                <button type="submit" class="btn btn-dark btn-lg w-100 mb-5 shadow">Salva Ricetta nel Sistema</button>
            </form>
        `;
    },
